...
This is an experimental and fun approach to image processing. the idea is to encode a given image into latent space, apply perturbation using randomly generated matrices, and then decode them back. 
...
--n Number of steps to repeat the process with different random matrices. default is 1.

--lb Lower bound for values in uniform matrices. default is 0.0

--ub Upper bound for values in uniform matrices. default is 1.0.

--density Density for sparse matricies. default is 0.1.

--p Degrees of freedom for the wishart matrices. default is C = dimension of a latent vector.
...
Perhaps the role of humans in the age of AI is to work effectively with new technologies, taking on more of an editorial role.
